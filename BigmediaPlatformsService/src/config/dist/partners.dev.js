...
var partners = {
  ...
  rtm: {
    ...
    fileInventory: ['www.rtm.com.ua/!os/bb.media/bb_rtmmodel.xlsx', 'www.rtm.com.ua/!os/bb.media/bb_rtmmodel_BM.xlsx'],
    http: {
      user: 'bmedia',
      password: 'Mkr2tZlg'
    },
    out: {
      ...
      serviceFileName: '/var/www/html/rtm/bigmedia_service.xlsx' // stockFileName: 'RTM/bigmedia_inventory.xlsx',

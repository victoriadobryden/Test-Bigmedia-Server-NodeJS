Ext.define("Bigmedia.view.field.PeriodFilterTag",{
    extend: "Ext.form.field.Tag",

    requires: [
        "Bigmedia.view.field.PeriodFilterTagController",
        "Bigmedia.view.field.PeriodFilterTagModel",
        "Bigmedia.Locales",
        'Bigmedia.store.Streets'
    ],

    controller: "field-periodfiltertag",
    viewModel: {
        type: "field-periodfiltertag"
    },
    xtype: 'periodtag',
    ...
    triggers: {
        newPeriod: {
            ...
            handler: function () {
                this.getController().newPeriodFilterClick();
            }
        }
    },

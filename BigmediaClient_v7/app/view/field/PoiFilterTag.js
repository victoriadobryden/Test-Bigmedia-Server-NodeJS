Ext.define("Bigmedia.view.field.PoiFilterTag",{
    extend: "Ext.form.field.Tag",
    xtype: "poifiltertag",

    requires: [
        "Bigmedia.view.field.PoiFilterTagController",
        "Bigmedia.view.field.PoiFilterTagModel",
        "Bigmedia.Locales"
    ],

    controller: "field-poifiltertag",
    // viewModel: {
    //     type: "field-poifiltertag"
    // },

    store: new Ext.data.Store({
        model: 'Bigmedia.model.PoiFilter',
        autoLoad: false
    }),
    ...
    triggers: {
        newPoi: {
            ...
            handler: function () {
                this.getController().newPoiFilterClick();
            }
        }
    },

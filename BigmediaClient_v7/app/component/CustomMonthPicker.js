Ext.define('Bigmedia.component.CustomMonthPicker', {
    extend: 'Ext.Component',
    alias: 'widget.custommonthpicker',
    ...
    smallCls: Ext.baseCSSPrefix + '-small',
    ...
    totalYears: 1,
    yearOffset: 0, //
    monthOffset: 6, // 12 months, 3 per row
    ...
    initComponent: function() {
        ...
        me.activeYear = me.getYear(new Date().getFullYear(), 0);
    ...
    beforeRender: function() {
        ...
        // for (; i < monthLen; i = i + 3) {
        for (; i < 12; i++ ) {
          // months.push(Ext.Date.monthNames[i], Ext.Date.monthNames[i + 1], Ext.Date.monthNames[i + 2])
            // months.push(shortName(i), shortName(i + monthLen));
            // months.push(shortName(i));
            months.push(Ext.Date.monthNames[i]);
        }
    ...
    onMonthClick: function(target, isDouble) {
        ...
        // me.resolveOffset(me.months.indexOf(target), me.monthOffset);
        me.updateBody();

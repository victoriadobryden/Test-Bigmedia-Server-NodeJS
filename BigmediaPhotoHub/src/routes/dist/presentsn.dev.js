...
router.get('/:side_number', asyncMW(function _callee(req, res) {
  var side_number, data;
  return regeneratorRuntime.async(function _callee$(_context) {
    while (1) {
      switch (_context.prev = _context.next) {
        case 0:
          side_number = req.params.side_number;
          _context.next = 3;
          return regeneratorRuntime.awrap(PhotosPresent.findOne({
            attributes: ['sideId', 'path', 'city', 'address', 'cathegory', 'supplier_sn', 'sizetype', 'sidetype', 'side_number'],
            where: {
